...
public class GridVisualiser : MonoBehaviour
{
    ...
    {
            new Color(255/255f,105/255f,180/255f),
    ...
    public void Update()
    {
        ...
        m_MeshRenderer.enabled = _isShow;
    ...
    //added this for hiding point clouds
    public void HidePointCloud(bool hideShowPlane)
    {
        _isShow = hideShowPlane;
        m_MeshRenderer.enabled = hideShowPlane;
        Update();
    }
